 ...
 app.innerHTML = `<main class="web-page">
  ...
  <section id="uvod" class="web-hero">
   ...
   <div class="hero-content">
    ...
    <p class="hero-facts">13 zastávek. Vyhraďte si celé odpoledne. Skutečné rekvizity. Historická Plzeň jako hřiště.</p>
  ...
  <section class="web-section feature-row">
   ...
   ${webReason('5. Zážitek na celé odpoledne','Vyhraďte si celé odpoledne. Většina týmů hraje kolem 4 hodin, pohodovější tempo může zabrat déle. Čeká vás 13 zastávek a trasa dlouhá asi 4–4,5 km.')}
