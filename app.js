...
function renderPrivacyPage(){
 renderLegalShell('Zásady zpracování osobních údajů', `
  <div class="legal-block"><h2>1. Správce osobních údajů</h2><p>Správcem osobních údajů je provozovatel služby Hravá Plzeň / Grollova zlatá stopa. Kontaktní e-mail: <a href="mailto:hravaplzen@gmail.com">hravaplzen@gmail.com</a>, telefon: <a href="tel:+420737256827">737 256 827</a>.</p><p class="note">Před ostrým spuštěním prodeje doporučujeme doplnit úplné identifikační údaje provozovatele, zejména jméno nebo název podnikatele, IČO a sídlo.</p></div>
...
function renderTermsPage(){
 renderLegalShell('Obchodní a storno podmínky', `
  <div class="legal-block"><h2>1. Provozovatel a služba</h2><p>Tyto podmínky upravují rezervaci a účast ve venkovní únikové hře Grollova zlatá stopa provozované službou Hravá Plzeň. Kontakt: <a href="mailto:hravaplzen@gmail.com">hravaplzen@gmail.com</a>, telefon: <a href="tel:+420737256827">737 256 827</a>.</p><p class="note">Před ostrým spuštěním prodeje doporučujeme doplnit úplné identifikační údaje provozovatele, zejména jméno nebo název podnikatele, IČO a sídlo.</p></div>
