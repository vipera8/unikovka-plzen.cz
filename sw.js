const CACHE='grollova-cesta-v135-selfie-ui';
const STATIC=['./','./index.html','./404.html','./style.css','./style.css?v=135','./app.js','./app.js?v=135','./game-data.js','./game-data.js?v=135','./manifest.webmanifest','./assets/images/certifikat-bez-titulu.jpg','./assets/images/groll_uvod.jpg','./assets/images/Groll_logo_na_sirku.jpg','./assets/images/Groll_logo_na_vysku.jpg','./assets/images/06_velka_synagoga_reseni_trojuhelniky.png','./assets/images/web_darkovy_voucher_fade.png','./assets/images/web_klice.jpg','./assets/images/groll_selfie_overlay.png'];
