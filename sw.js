const CACHE='grollova-cesta-v198-groll-selfie-controls';
const STATIC=['./','./index.html','./404.html','./style.css','./style.css?v=194','./app.js','./app.js?v=198','./game-data.js','./game-data.js?v=194','./manifest.webmanifest','./seznam-wmt-iNTy4RkzYHeUNpmhy6t8nriA2EAK4Cqz.txt','./assets/images/certifikat-bez-titulu.jpg','./assets/images/certifikat-kratka-verze.png','./assets/images/groll_uvod.jpg','./assets/images/Groll_logo_na_sirku.jpg','./assets/images/Groll_logo_na_vysku.jpg','./assets/images/06_velka_synagoga_reseni_trojuhelniky.png','./assets/images/web_darkovy_voucher_fade.png','./assets/images/web_klice.jpg','./assets/images/groll_selfie_overlay.png','./assets/images/selfie_frame_landscape.png','./assets/images/selfie_frame_team_wide.png'];
